package com.themescoder.laravelecommerce.constant;
...
public class ConstantValues {
    ...
    public static final String ECOMMERCE_URL = "http://beja-store.tn/COVIDE19/public/";
    ...
    public static final String CODE_VERSION = "4.0.1";
