...
import com.themescoder.laravelecommerce.adapters.ShippingServicesAdapter;
...
import com.themescoder.laravelecommerce.models.shipping_model.ShippingRateDetails;
            ...
            public void onClick(View v) {
                ...
                if (shippingService != null) {
                    ...
                    if (isUpdate) {
                        ...
                        // Navigate to CheckoutFinal Fragment
                        Fragment fragment = new CheckoutFinal();
                        FragmentManager fragmentManager = getFragmentManager();
                        fragmentManager.beginTransaction().replace(R.id.main_fragment, fragment,getString(R.string.checkout))
